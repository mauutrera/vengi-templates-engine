...
class Layout
{
    ...
    public static function set($layout)                             # Function set(get the name of the layout).
    {
        ...
        if (Vengi::$layouts_path) {                                 # If I set the layout path.
            $file = Vengi::$layouts_path."/$layout.php";            # The path is set.
        } else {
            $file = Vengi::$views_path."/layouts/$layout.php";      # Otherwise use the views/layouts path.
        }
        ...
        Vengi::render_path(__DIR__.'/views/layouts');               # Set and create (if not exists) the layouts render path.
        ...
        if (str_contains($layout_template,'@{_Content_}@')) {       # If exists @{_Content_}@ It means that it is a layout. 
            ...
            $header = Vengi::render($header);                       # Render/Process the header.
            $footer = $layout_template[1];                          # Save the layout footer.
            $footer = Vengi::render($footer);                       # Render/Process the footer.
            ...
            $layout_template = Vengi::render($layout_template);     # Render/Process the layout componet.
